    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          <FormAfiliacion
            onClose={onClose}
            montoConObra={montoConObra}
            montoSinObra={montoSinObra}
          />
        </div>
      </div>
    </div>
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 max-w-xl mx-auto leading-relaxed">
            Conocé en detalle todos los términos y condiciones de tu plan. En
            Evenser creemos que la confianza se construye con claridad.
          </p>
        </div>
        ...
        <div className="bg-stone-50 border border-stone-200 rounded-3xl overflow-hidden mb-8">
          ...
          <div className="bg-stone-800 px-8 py-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              ...
              <h3 className="text-white font-bold text-xl">
                Contrato de Prestación de Servicios Fúnebres
              </h3>
              <p className="text-stone-400 text-sm mt-1">
                Evenser – Eventos y Servicios Sociales · Colonia Elisa, Chaco
              </p>
            </div>
              ...
              return (
                <div key={c.numero} className="group">
                  ...
                  >
                    ...
                    {/* Ícono */}
                    <span
                      className={`flex-shrink-0 text-stone-400 transition-transform duration-200 ${abierta ? "rotate-180" : ""}`}
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
          ...
          <div className="bg-stone-100 border-t border-stone-200 px-8 py-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="flex items-start gap-3 sm:flex-row sm:items-center">
              <svg
                className="w-4 h-4 text-stone-500 flex-shrink-0 mt-0.5 sm:mt-0"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <p className="text-stone-500 text-xs leading-relaxed">
                Al completar la solicitud de afiliación, el Afiliado declara
                haber leído, comprendido y aceptado la totalidad de las
                cláusulas del presente contrato. Este documento tiene plena
                validez legal.
              </p>
            </div>
            <a
        ...
        <div className="bg-stone-900 rounded-2xl p-8 text-center">
          <h3 className="text-white font-bold text-xl mb-2">
            ¿Estás listo para afilirte?
          </h3>
          <p className="text-stone-400 text-sm mb-6 max-w-md mx-auto">
            Completá tu solicitud en minutos. Nuestro equipo te contactará para
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-stone-800 rounded-2xl p-8 border border-stone-700">
              ...
              <p className="text-4xl font-bold text-white mb-1">
                ${montoConObra.toLocaleString("es-AR")}
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-stone-800 relative">
              ...
              <p className="text-4xl font-bold text-gray-900 mb-1">
                ${montoSinObra.toLocaleString("es-AR")}
      ...
      <footer className="bg-stone-950 py-6">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-stone-500 text-sm">
            © {new Date().getFullYear()} Evenser — Eventos y Servicios Sociales
          </p>
